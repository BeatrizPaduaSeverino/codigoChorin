...
real*8, intent(out)   :: Nodes(0:), Dual_Nodes(:)

optional :: Dual_Nodes

integer :: Number_Nodes, i!, Degree
real*8    :: Gauss_Nodes(1:ubound(Nodes,1))
...
real*8, intent(in)  :: Nodes(0:)
real*8, intent(out) :: Equations(0:)

integer :: Number_Nodes, i
real*8    :: Extrema(0:ubound(Nodes,1)+1), Extrema_Errors(0:ubound(Nodes,1)+1,0:2)           
