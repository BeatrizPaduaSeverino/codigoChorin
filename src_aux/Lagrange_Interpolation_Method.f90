...
real*8, intent(in)    :: Nodes(0:), Point
integer, intent(in) :: Derivatives(:)
real*8, intent(out)   :: Coefficients(:,0:)

integer :: Number_Nodes, Lowest_Derivative, Highest_Derivative, j, r, k
real*8    :: L_j(-1:size(Nodes)), dx_r, dx_jr, factorial
...
real*8, intent(in)  :: Coefficients(:,0:), Values(0:)
real*8, intent(out) :: Interpolant(:)
...
real*8, intent(in)    :: Nodes(0:), Point
integer, intent(in) :: Derivatives(:)
real*8, intent(out)   :: Error_Polynomial(:)

integer :: Number_Nodes, Lowest_Derivative, Highest_Derivative, r, k
real*8    :: pi(-1:size(Nodes)), factorial
