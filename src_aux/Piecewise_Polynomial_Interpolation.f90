...
real*8,    intent(in)  :: Grid_Nodes(0:), Nodal_Values(0:), &
                        Interpolation_Points(0:)
integer, intent(in)  :: Derivatives(:)
real*8,    intent(out) :: Interpolated_Values(0:,:)
...
real*8    :: Coefficients(ubound(Derivatives,1),0:Polynomial_Degree)
...
pure subroutine Interpolation_Matrix(Grid_Nodes, Interpolation_Points, &
                                     Derivatives, Matrix)
real*8,    intent(in)  :: Grid_Nodes(0:), Interpolation_Points(0:)
integer, intent(in)  :: Derivatives(:)
real*8,    intent(out) :: Matrix(0:,:,0:)
...
real*8, intent(in)     :: Nodes(0:), Points(0:)
